		...
		switch(screen)
			...
			if(9)
				...
				if(viewing_channel.censored)
					dat+="<FONT COLOR='red'><B>ATTENTION: </B>This channel has been deemed as threatening to the welfare of the station, and marked with a [using_map.company_name] D-Notice.<BR>"
