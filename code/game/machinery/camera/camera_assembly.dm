/obj/item/weapon/camera_assembly
	...
	matter_legacy = list(DEFAULT_WALL_MATERIAL = 700,"glass" = 300)

	//	Motion, EMP-Proof, X-Ray
	var/list/obj/item/possible_upgrades = list(/obj/item/device/assembly/prox_sensor, /obj/item/stack/legacy_material/osmium, /obj/item/weapon/stock_parts/scanning_module)
