...
/obj/structure/loot_pile/maint/trash
	...
	common_loot = list(
		...
		/obj/item/stack/legacy_material/steel{amount = 5},
		/obj/item/stack/legacy_material/cardboard{amount = 5},
		/obj/item/poster,
...
/obj/structure/loot_pile/mecha
	...
	common_loot = list(
		...
		/obj/item/stack/legacy_material/steel{amount = 40}
		)
...
/obj/structure/loot_pile/mecha/ripley
	...
	common_loot = list(
		...
		/obj/random/tank,
		/obj/random/tech_supply/component,
		/obj/item/stack/legacy_material/steel{amount = 25},
		/obj/item/stack/legacy_material/glass{amount = 10},
		/obj/item/stack/legacy_material/plasteel{amount = 5},
...
/obj/structure/loot_pile/mecha/deathripley
	...
	common_loot = list(
		...
		/obj/random/tech_supply/component,
		/obj/item/stack/legacy_material/steel{amount = 40},
		/obj/item/stack/legacy_material/glass{amount = 20},
		/obj/item/stack/legacy_material/plasteel{amount = 10},
		/obj/item/mecha_parts/chassis/ripley,
		/obj/item/mecha_parts/part/ripley_torso,
		/obj/item/mecha_parts/part/ripley_left_arm,
		/obj/item/mecha_parts/part/ripley_right_arm,
...
/obj/structure/loot_pile/mecha/phazon
	...
	common_loot = list(
		...
		/obj/item/stack/legacy_material/plasteel{amount = 20},
		/obj/item/stack/legacy_material/durasteel{amount = 10},
