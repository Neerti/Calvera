...
/obj/item/device/t_scanner
	...
	matter_legacy = list(DEFAULT_WALL_MATERIAL = 150)
...
/obj/item/device/t_scanner/upgraded
	...
	matter_legacy = list(DEFAULT_WALL_MATERIAL = 500, PHORON = 150)
...
/obj/item/device/t_scanner/advanced
	...
	matter_legacy = list(DEFAULT_WALL_MATERIAL = 1500, PHORON = 200, SILVER = 250)
