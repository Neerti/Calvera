...
/datum/legacy_modifier/delayed_toxin_sting
...
/datum/legacy_modifier/delayed_toxin_sting/on_expire()
	holder.adjustToxLoss(rand(20, 30))

/datum/legacy_modifier/delayed_toxin_sting/strong/on_expire()
...
/mob/proc/changeling_delayed_toxic_sting()
	...
	var/type_to_give = /datum/legacy_modifier/delayed_toxin_sting
