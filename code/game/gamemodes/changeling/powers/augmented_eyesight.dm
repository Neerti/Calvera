...
/mob/proc/changeling_augmented_eyesight()
	...
	if(active)
		...
		C.add_legacy_modifier(/datum/legacy_modifier/changeling/thermal_sight, 0, src)
...
//		C.dna.species.invis_sight = SEE_INVISIBLE_MINIMUM
		...
		C.remove_legacy_modifiers_of_type(/datum/legacy_modifier/changeling/thermal_sight)
//		C.permanent_sight_flags &= ~SEE_MOBS
