...
//	var/liquid_name = null
	...
	/// If above 0, the material is radioactive, and things made out of it will emit radiation.
	var/radioactivity = 0
	...
	Distinct from the weight variable to make balancing less of a headache.*/
	var/density = 1
