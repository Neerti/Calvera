...
/obj/item/ammo_magazine/s357
	...
	matter_legacy = list(DEFAULT_WALL_MATERIAL = 1260)
	max_ammo = 6
	multiple_sprites = 1
...
/obj/item/ammo_magazine/s38
	...
	icon_state = "38"
	caliber = ".38"
	matter_legacy = list(DEFAULT_WALL_MATERIAL = 360)
...
/obj/item/ammo_magazine/m45
	...
	matter_legacy = list(DEFAULT_WALL_MATERIAL = 525) //metal costs are very roughly based around 1 .45 casing = 75 metal
	caliber = ".45"
	max_ammo = 7
	multiple_sprites = 1
...
/obj/item/ammo_magazine/m45uzi
	...
	mag_type = MAGAZINE
	ammo_type = /obj/item/ammo_casing/a45
	matter_legacy = list(DEFAULT_WALL_MATERIAL = 1200)
	caliber = ".45"
	max_ammo = 16
	multiple_sprites = 1
...
/obj/item/ammo_magazine/m45tommy
	...
	mag_type = MAGAZINE
	ammo_type = /obj/item/ammo_casing/a45
	matter_legacy = list(DEFAULT_WALL_MATERIAL = 1500)
	caliber = ".45"
	max_ammo = 20
...
/obj/item/ammo_magazine/m45tommydrum
	...
	mag_type = MAGAZINE
	ammo_type = /obj/item/ammo_casing/a45
	matter_legacy = list(DEFAULT_WALL_MATERIAL = 3750)
	caliber = ".45"
	max_ammo = 50
...
/obj/item/ammo_magazine/clip/c45
	...
	caliber = ".45"
	ammo_type = /obj/item/ammo_casing/a45
	matter_legacy = list(DEFAULT_WALL_MATERIAL = 675) // metal costs very roughly based around one .45 casing = 75 metal
	max_ammo = 9
	multiple_sprites = 1
...
/obj/item/ammo_magazine/m9mm
	...
	mag_type = MAGAZINE
	matter_legacy = list(DEFAULT_WALL_MATERIAL = 600)
	caliber = "9mm"
...
/obj/item/ammo_magazine/m9mm/compact
	...
	origin_tech = list(TECH_COMBAT = 2)
	mag_type = MAGAZINE
	matter_legacy = list(DEFAULT_WALL_MATERIAL = 480)
	caliber = "9mm"
	ammo_type = /obj/item/ammo_casing/a9mm
	max_ammo = 8
	multiple_sprites = 1
...
/obj/item/ammo_magazine/m9mmt/ap
	...
	matter_legacy = list(DEFAULT_WALL_MATERIAL = 1000, MAT_PLASTEEL = 2000)
...
/obj/item/ammo_magazine/m9mmp90
	...
	mag_type = MAGAZINE
	ammo_type = /obj/item/ammo_casing/a9mm/ap
	matter_legacy = list(DEFAULT_WALL_MATERIAL = 3000)
	caliber = "9mm"
	max_ammo = 50
	multiple_sprites = 1
...
/obj/item/ammo_magazine/clip/c9mm
	...
	caliber = "9mm"
	ammo_type = /obj/item/ammo_casing/a9mm
	matter_legacy = list(DEFAULT_WALL_MATERIAL = 540) // metal costs are very roughly based around one 9mm casing = 60 metal
	max_ammo = 9
	multiple_sprites = 1
...
/obj/item/ammo_magazine/m9mmAdvanced/ap
	...
	icon_state = "S9mm"
	ammo_type = /obj/item/ammo_casing/a9mm/ap
	matter_legacy = list(DEFAULT_WALL_MATERIAL = 2000)
...
/obj/item/ammo_magazine/clip/c10mm
	...
	caliber = "10mm"
	ammo_type = /obj/item/ammo_casing/a10mm
	matter_legacy = list(DEFAULT_WALL_MATERIAL = 675) // metal costs are very roughly based around one 10mm casing = 75 metal
	max_ammo = 9
	multiple_sprites = 1
...
/obj/item/ammo_magazine/m545
	...
	mag_type = MAGAZINE
	caliber = "5.45mm"
	matter_legacy = list(DEFAULT_WALL_MATERIAL = 1800)
...
/obj/item/ammo_magazine/m545/ext
	...
	matter_legacy = list(DEFAULT_WALL_MATERIAL = 2700)
	max_ammo = 30
...
/obj/item/ammo_magazine/m545/small
	...
	matter_legacy = list(DEFAULT_WALL_MATERIAL = 900)
	max_ammo = 10
...
/obj/item/ammo_magazine/clip/c545
	...
	caliber = "5.45mm"
	ammo_type = /obj/item/ammo_casing/a545
	matter_legacy = list(DEFAULT_WALL_MATERIAL = 450) // metal costs are very roughly based around one 10mm casing = 180 metal
	max_ammo = 5
	multiple_sprites = 1
...
/obj/item/ammo_magazine/m545saw
	...
	mag_type = MAGAZINE
	caliber = "5.45mm"
	matter_legacy = list(DEFAULT_WALL_MATERIAL = 10000)
	ammo_type = /obj/item/ammo_casing/a545
...
/obj/item/ammo_magazine/clip/c44
	...
	caliber = ".44"
	ammo_type = /obj/item/ammo_casing/a44
	matter_legacy = list(DEFAULT_WALL_MATERIAL = 1620) // metal costs are very roughly based around one .50 casing = 180 metal
	max_ammo = 9
	multiple_sprites = 1
...
/obj/item/ammo_magazine/s44
	...
	icon_state = "44"
	ammo_type = /obj/item/ammo_casing/a44
	matter_legacy = list(DEFAULT_WALL_MATERIAL = 1260) //metal costs are very roughly based around 1 .45 casing = 75 metal
	caliber = ".44"
	max_ammo = 6
	multiple_sprites = 1
...
/obj/item/ammo_magazine/m762m // Intentionally not a subtype of m762 because it's supposed to be incompatible with the Z8 Bulldog rifle.
	...
	mag_type = MAGAZINE
	caliber = "7.62mm"
	matter_legacy = list(DEFAULT_WALL_MATERIAL = 4000)
	ammo_type = /obj/item/ammo_casing/a762
	max_ammo = 20
	multiple_sprites = 1
...
/obj/item/ammo_magazine/m762garand
	...
	mag_type = MAGAZINE
	caliber = "7.62mm"
	matter_legacy = list(DEFAULT_WALL_MATERIAL = 1600)
	ammo_type = /obj/item/ammo_casing/a762
	max_ammo = 8
	multiple_sprites = 1
...
/obj/item/ammo_magazine/clip/c762
	...
	caliber = "7.62mm"
	ammo_type = /obj/item/ammo_casing/a762
	matter_legacy = list(DEFAULT_WALL_MATERIAL = 1000) // metal costs are very roughly based around one 7.62 casing = 200 metal
	max_ammo = 5
	multiple_sprites = 1
...
/obj/item/ammo_magazine/m12gdrum
	...
	mag_type = MAGAZINE
	caliber = "12g"
	matter_legacy = list(DEFAULT_WALL_MATERIAL = 13000)
...
/obj/item/ammo_magazine/clip/c12g
	...
	caliber = "12g"
	ammo_type = /obj/item/ammo_casing/a12g
	matter_legacy = list(DEFAULT_WALL_MATERIAL = 1070) // slugs shells x2 + 350 metal for the clip itself.
	max_ammo = 2
	multiple_sprites = 1
...
/obj/item/ammo_magazine/clip/c12g/pellet
	...
	ammo_type = /obj/item/ammo_casing/a12g/pellet
	matter_legacy = list(DEFAULT_WALL_MATERIAL = 1070) // buckshot and slugs cost the same
...
/obj/item/ammo_magazine/clip/c12g/beanbag
	...
	ammo_type = /obj/item/ammo_casing/a12g/beanbag
	matter_legacy = list(DEFAULT_WALL_MATERIAL = 710) //beanbags x2 + 350 metal
