...
GLOBAL_LIST_INIT(plant_item_products, list(
	/obj/item/stack/legacy_material/cloth = 30,
	/obj/item/stack/legacy_material/wax = 20,
	/obj/item/stack/legacy_material/log = 30,
	/obj/item/stack/legacy_material/resin = 10,
