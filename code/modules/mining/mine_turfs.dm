...
/turf/simulated/mineral/proc/artifact_debris(var/severity = 0)
	...
	for(var/j in 1 to rand(1, 3 + max(min(severity, 1), 0) * 2))
		switch(rand(1,7))
			...
			if(2)
				new /obj/item/stack/legacy_material/plasteel(src, rand(5,25))
			if(3)
				new /obj/item/stack/legacy_material/steel(src, rand(5,25))
			if(4)
				new /obj/item/stack/legacy_material/plasteel(src, rand(5,25))
			if(5)
			...
			if(7)
				new /obj/item/stack/legacy_material/uranium(src, rand(5,25))
