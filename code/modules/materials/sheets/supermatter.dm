...
/obj/item/stack/legacy_material/supermatter
...
/obj/item/stack/legacy_material/supermatter/proc/update_mass()	// Due to how dangerous they can be, the item will get heavier and larger the more are in the stack.
	slowdown = amount / 10
	w_class = min(5, round(amount / 10) + 1)
	throw_range = round(amount / 7) + 1

/obj/item/stack/legacy_material/supermatter/use(var/used)
	. = ..()
	update_mass()
	return

/obj/item/stack/legacy_material/supermatter/attack_hand(mob/user)
	. = ..()
...
/obj/item/stack/legacy_material/supermatter/ex_act(severity)	// An incredibly hard to manufacture material, SM chunks are unstable by their 'stabilized' nature.
