// Stacked resources. They use a material decl for a lot of inherited values.
/obj/item/stack/material2
	force = 5
	throwforce = 5
	w_class = ITEMSIZE_NORMAL
	plural_icon_state_suffix = "-multi"
	max_icon_state_suffix = "-max"
	throw_speed = 3
	throw_range = 3
	max_amount = 60
	randpixel = 3
...
/obj/item/stack/material2/Initialize(mapload, amount, _material, _reinf_material)
...
/obj/item/stack/material2/proc/update_strings()
	if(amount > 1)
