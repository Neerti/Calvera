...
/datum/legacy_modifier/cloning_sickness
...
/datum/legacy_modifier/no_clone
...
/datum/legacy_modifier/cloning_sickness/promethean
...
/datum/legacy_modifier/franken_sickness
...
/datum/legacy_modifier/franken_sickness/can_apply(var/mob/living/L)
	if(!ishuman(L))
		return FALSE
...
/datum/legacy_modifier/franken_sickness/tick()
	if(holder.stat != DEAD)
...
/datum/legacy_modifier/franken_recovery/can_apply(var/mob/living/L)
	if(!ishuman(L))
		return FALSE
	if(L.isSynthetic()) //Nonhumans and Machines cannot be Frankensteined, at this time.
		return FALSE
