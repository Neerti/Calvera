...
/datum/legacy_modifier/trait/phobia
...
/datum/legacy_modifier/trait/phobia/tick()
	if(holder.stat)
...
/datum/legacy_modifier/trait/phobia/proc/adjust_fear(var/amount)
...
/datum/legacy_modifier/trait/phobia/proc/should_fear()
	return FALSE


// Actual phobia trait implementations below.

/datum/legacy_modifier/trait/phobia/haemophobia
	name = "haemophobia"
...
/datum/legacy_modifier/trait/phobia/haemophobia/check_if_valid()
	if(iscultist(holder)) // Nar-nar can't be having cultists afraid of blood.
		expire()
	else
		..()

/datum/legacy_modifier/trait/phobia/haemophobia/should_fear()
	if(holder.blinded)
...
/datum/legacy_modifier/trait/phobia/arachnophobe
	name = "arachnophobia"
...
/datum/legacy_modifier/trait/phobia/arachnophobe/should_fear()
	if(holder.blinded)
		return 0 // Can't fear what cannot be seen.
...
/datum/legacy_modifier/trait/phobia/nyctophobe
	name = "nyctophobia"
...
/datum/legacy_modifier/trait/phobia/nyctophobe/should_fear()
	if(holder.blinded)
...
/datum/legacy_modifier/trait/phobia/claustrophobe
	name = "claustrophobia"
...
/datum/legacy_modifier/trait/phobia/claustrophobe/should_fear()
	if(holder.blinded)
...
/datum/legacy_modifier/trait/phobia/blennophobe
	name = "blennophobia"
...
/datum/legacy_modifier/trait/phobia/blennophobe/should_fear()
	if(holder.blinded)
		return 0 // Can't fear what cannot be seen.
...
/datum/legacy_modifier/trait/phobia/trypanophobe
	name = "trypanophobia"
...
/datum/legacy_modifier/trait/phobia/trypanophobe/should_fear()
	if(holder.blinded)
...
/datum/legacy_modifier/trait/phobia/xenophobia
	name = "xenophobia"
...
/datum/legacy_modifier/trait/phobia/xenophobia/tick()
	if(holder.stat)
		return // You got bigger problems.
...
/datum/legacy_modifier/trait/phobia/xenophobia/proc/intermittent_message()
...
/datum/legacy_modifier/trait/phobia/xenophobia/proc/get_xenos()
	return list()


/datum/legacy_modifier/trait/phobia/xenophobia/proc/make_message(var/mob/living/L)
	return "Someone forgot to override this output message."


// This is the catch-all 'everyone but [my species] is up to no good' trait, as opposed to the other specialized variants.
/datum/legacy_modifier/trait/phobia/xenophobia/generic
	name = "xenophobia"
	desc = "The mind of the Alien is unknowable, and as such, their intentions cannot be known.  You always watch the xenos closely, as they most certainly are watching you \
	closely, waiting to strike."
...
/datum/legacy_modifier/trait/phobia/xenophobia/generic/get_xenos()
	var/list/xenos = list()
	if(!ishuman(holder))
		return
...
/datum/legacy_modifier/trait/phobia/xenophobia/generic/make_message(var/mob/living/carbon/human/H)
...
/datum/legacy_modifier/trait/phobia/xenophobia/human
...
/datum/legacy_modifier/trait/phobia/xenophobia/human/get_xenos()
...
/datum/legacy_modifier/trait/phobia/xenophobia/human/make_message(var/mob/living/carbon/human/H)
	// Do special responses first if possible.
...
/datum/legacy_modifier/trait/phobia/xenophobia/skrell
...
/datum/legacy_modifier/trait/phobia/xenophobia/skrell/get_xenos()
...
/datum/legacy_modifier/trait/phobia/xenophobia/skrell/make_message(var/mob/living/carbon/human/H)
	// Do special responses first if possible.
