/datum/codex_entry/communicators
	name = "communicator"
	associated_paths = list(/obj/item/device/communicator, /obj/item/device/communicator/watch)
	mechanics_text = "This device allows someone to speak to another player sourced from the observer pool, as well as other communicators linked to it. \
	...
	lore_text = "As a concept, a device that allows long-distance communication has existed prior to humans leaving their star. A device that can accomplish \
	...
	antag_text = "Electromagnetic pulses will cause the device to disconnect all linked communicators. Turning off the Exonet node at the Telecomms \
