/decl/codex_category/matter
	name = "Matter"
	desc = "Various natural and artificial substances."

/decl/codex_category/matter/Initialize()
...
//		material_info += "<li>Its boiling point is [mat.boiling_point] K.</li>"
		...
		if(mat.specific_heat_capacity)
			material_info += "<li>It has a [CODEX_LINK("specific heat capacity")] of <b>[mat.specific_heat_capacity]</b> J/°K.</li>"
