...
/datum/unit_test_legacy/integrated_circuits/floor/cosine_1
	name = "Trig Circuits: Cosine - 1"
	circuit_type = /obj/item/integrated_circuit/trig/cosine
	inputs_to_give = list(90)
	expected_outputs = list(0)

/datum/unit_test_legacy/integrated_circuits/floor/cosine_2
...
/datum/unit_test_legacy/integrated_circuits/floor/tangent_1
