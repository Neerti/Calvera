/datum/unit_test_legacy/integrated_circuits/equals_1
...
/datum/unit_test_legacy/integrated_circuits/equals_6/arrange()
	A = new(get_standard_turf())
	inputs_to_give = list(weakref(A), weakref(A))
	..()

/datum/unit_test_legacy/integrated_circuits/equals_6/clean_up()
	qdel(A)
	..()

/datum/unit_test_legacy/integrated_circuits/equals_7
...
/datum/unit_test_legacy/integrated_circuits/equals_7/arrange()
	A = new(get_standard_turf())
	B = new(get_standard_turf())
	inputs_to_give = list(weakref(A), weakref(B))
	..()

/datum/unit_test_legacy/integrated_circuits/equals_7/clean_up()
	qdel(A)
	qdel(B)
	..()
...
/datum/unit_test_legacy/integrated_circuits/not_equals_1
	name = "Logic Circuits: Not Equals - String True"
	circuit_type = /obj/item/integrated_circuit/logic/binary/not_equals
	inputs_to_give = list("Test", "Nope")
	expected_outputs = list(TRUE)

/datum/unit_test_legacy/integrated_circuits/not_equals_2
	name = "Logic Circuits: Not Equals - String False"
	circuit_type = /obj/item/integrated_circuit/logic/binary/not_equals
	inputs_to_give = list("Test", "Test")
	expected_outputs = list(FALSE)

/datum/unit_test_legacy/integrated_circuits/not_equals_3
	name = "Logic Circuits: Not Equals - Number True"
	circuit_type = /obj/item/integrated_circuit/logic/binary/not_equals
	inputs_to_give = list(150, 20)
	expected_outputs = list(TRUE)

/datum/unit_test_legacy/integrated_circuits/not_equals_4
...
/datum/unit_test_legacy/integrated_circuits/or_1
	name = "Logic Circuits: Or - True First"
	circuit_type = /obj/item/integrated_circuit/logic/binary/or
	inputs_to_give = list("One", null)
	expected_outputs = list(TRUE)

/datum/unit_test_legacy/integrated_circuits/or_2
	name = "Logic Circuits: Or - True Second"
	circuit_type = /obj/item/integrated_circuit/logic/binary/or
	inputs_to_give = list(null, "Two")
	expected_outputs = list(TRUE)

/datum/unit_test_legacy/integrated_circuits/or_3
	name = "Logic Circuits: Or - True Both"
	circuit_type = /obj/item/integrated_circuit/logic/binary/or
	inputs_to_give = list("One", "Two")
	expected_outputs = list(TRUE)

/datum/unit_test_legacy/integrated_circuits/or_4
...
/datum/unit_test_legacy/integrated_circuits/less_than_1
...
/datum/unit_test_legacy/integrated_circuits/less_than_2
...
/datum/unit_test_legacy/integrated_circuits/less_than_or_equal_1
...
/datum/unit_test_legacy/integrated_circuits/less_than_or_equal_2
	name = "Logic Circuits: Less Than Or Equal - True 2"
	circuit_type = /obj/item/integrated_circuit/logic/binary/less_than_or_equal
	inputs_to_give = list(40, 40)
	expected_outputs = list(TRUE)

/datum/unit_test_legacy/integrated_circuits/less_than_or_equal_3
...
/datum/unit_test_legacy/integrated_circuits/greater_than_1
...
/datum/unit_test_legacy/integrated_circuits/greater_than_2
...
/datum/unit_test_legacy/integrated_circuits/greater_than_or_equal_1
...
/datum/unit_test_legacy/integrated_circuits/greater_than_or_equal_2
	name = "Logic Circuits: Greater Than Or Equal - True 2"
	circuit_type = /obj/item/integrated_circuit/logic/binary/greater_than_or_equal
	inputs_to_give = list(30, 30)
	expected_outputs = list(TRUE)

/datum/unit_test_legacy/integrated_circuits/greater_than_or_equal_3
...
/datum/unit_test_legacy/integrated_circuits/not_1
...
/datum/unit_test_legacy/integrated_circuits/not_2
